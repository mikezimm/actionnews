...
export const defCommandIconStyles = {
  root: {padding:'10px !important', height: 32, marginRight: null, marginLeft: null },//color: 'green' works here
  icon: { 
    fontSize: 18,
    fontWeight: "normal",
    margin: '0px 2px',
...
export function createIconButton(iconName, titleText, _onClick, thisID,  iconStyles){
  ...
  export function createIconButtonWithReturnVal(iconName, titleText, _onClick, thisID,  iconStyles, sendValue){
