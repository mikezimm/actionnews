...
import { IActionnewsState, ActionStatus, IActionItem, IActionStatus, IPlannerTask } from '../IActionnewsState';
...
export function buildFormFields(parentProps:IActionnewsProps , parentState: IActionnewsState ){
...
export function buildProjectFormFields(parentProps:IActionnewsProps , parentState: IActionnewsState ){
